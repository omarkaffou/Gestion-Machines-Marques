                ...
                <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            ...
                            <a class="navbar-brand" href="javascript:void(0)">Machines Par Date</a>
                        </div>
                ...
                <div class="content">
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="title">Recherche par date</h5>
                                </div>
                                <div class="card-body">
                                    <form>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="searchByDate">Enter la 1ere date :</label>
                                                    <input class="form-control mr-sm-2" type="text" onfocus="(this.type = 'date')"
                                                           onblur="(this.type = 'text')" placeholder="1ere Date" aria-label="Search" id="date1" >
                                                    <label for="searchByDate">Enter la 2eme date :</label>
                                                    <input class="form-control mr-sm-2" type="text" onfocus="(this.type = 'date')"
                                                           onblur="(this.type = 'text')" placeholder="2eme Date" aria-label="Search" id="date2">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-fill btn-primary" id="searchByDate">Chercher</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card ">
                                <div class="card-header">
                                    <h4 class="card-title"> Liste Machines</h4>
                                </div>
                                <div class="card-body">
