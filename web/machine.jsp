                ...
                <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            ...
                            <a class="navbar-brand" href="javascript:void(0)">Machines</a>
                        </div>
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" onfocus="(this.type = 'date')"
                                                           onblur="(this.type = 'text')" placeholder="Date d'achat" id="inputDateAchat" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-fill btn-primary" id="submitMachine">Ajouter</button>
                                    <button type="submit" class="btn btn-fill btn-primary" id="submitMachineUpdate">Modifier</button>
                                </div>
                            </div>
                        </div>
                    </div>
