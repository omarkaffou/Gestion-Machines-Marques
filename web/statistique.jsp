                ...
                <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            ...
                            <a class="navbar-brand" href="javascript:void(0)">Statistiques</a>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card card-chart">
                                <div class="card-header">
                                    <h5 class="card-category">Nombre de machines par marque</h5>
                                    <h3 class="card-title"><i class="tim-icons icon-chart-pie-36 text-primary"></i>Pie Chart</h3>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-lg-4">
                            <div class="card card-chart">
                                <div class="card-header">
                                    <h5 class="card-category">Nombre de machines par marque</h5>
                                    <h3 class="card-title"><i class="tim-icons icon-chart-bar-32 text-info"></i>Bar Chart</h3>
                                </div>
                                <div class="card-body">
                                    <div class="chart-area">
                        ...
                        <div class="col-lg-4">
                            <div class="card card-chart">
                                <div class="card-header">
                                    <h5 class="card-category">Nombre de machines par marque</h5>
                                    <h3 class="card-title"><i class="tim-icons icon-atom text-success"></i>Doughnut Chart</h3>
                                </div>
                                <div class="card-body">
                                    <div class="chart-area">
