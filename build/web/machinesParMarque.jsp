                ...
                <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            ...
                            <a class="navbar-brand" href="javascript:void(0)">Machines Par Marque</a>
                        </div>
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="title">Recherche Par Marque</h5>
                                </div>
                                <div class="card-body">
                                    <form>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="inputMarqueSearch">Selectionner la marque :</label>
                                                    <select class="form-control mr-sm-6" style="" id="inputMarqueSearch">
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-fill btn-primary" id="search">Chercher</button>
                                </div>
                            </div>
                        </div>
                    </div>
